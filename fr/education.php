                                    ...
                                    <div class="media">
                                        <div class="media-content">
                                            <div class="graduationTitle">
                                                <h5>Titre professionnel · Développeuse Web et Web mobile - FullStack JavaScript</h5>
                                            </div>
                                            <div class="lieu">Ecole O'Clock</div>
                                            <span class="date">2023 · En cours</span>
                                        </div>
                            ...
                            <div class="graduation">
                                <div class="card-content">
                                    <div class="media">
                                        <div class="media-content">
                                            <div class="graduationTitle">
                                                <h5>Master II · Politiques publiques · Action Humanitaire Internationale</h5>
                                            </div>
                                    ...
                                    <div class="content">
                                        <p><strong>Option</strong> : Urgence et réhabilitation<br>
                            ...
                            <div class="graduation">
                                <div class="card-content">
                                    <div class="media">
                                        <div class="media-content">
                                            <div class="graduationTitle">
                                                <h5>Master I · Sciences Politiques</h5>
                                            </div>
                                    ...
                                    <div class="content">
                                        <p><strong>Mention</strong> : Relations Internationales <br>
                                            Diplômée<br><br>
                                            ...
                                            <strong>Mémoire</strong> : <i>"L’externalisation des contrôles migratoires au Sahel. Étude sur un nouvel outil d’une politique européenne extra territorialisée de gestion des frontières"</i>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-content">
                                    <div class="media">
                                        <div class="media-content">
                                            ...
                                            <div class="lieu">Université Toulouse I Capitole</div>
                                    ...
                                    <div class="content">
                                        <p><strong>Mention</strong> : Droit Public<br>Diplomée mention AB<br><br>
                            ...
                            <div class="graduation">
                                <div class="card-content">
                                    <div class="media">
                                        <div class="media-content">
                                            <div class="graduationTitle">
                                                <h5>Capacité en Droit</h5>
                                            </div>
                                            <div class="lieu">Conservatoire national des arts et métiers</div>
                                    ...
                                    <div class="content">
                                        <p>Diplômee délivré par l'Université Toulouse I Capitole <br>Diplomé mention B</p>
                                    </div>
                                </div>
                            </div>
                        </div>
