export default function Icon({ name, size = 18, stroke = 1.6 }) {
  ...
  switch (name) {
    ...
    case "hands":
      return (
        <svg {...props}>
          <path d="M3 12c1.5-1 4-1 6 1l3 3 3-3c2-2 4.5-2 6-1" />
          <path d="M3 16c1.5-1 4-1 6 1l3 3 3-3c2-2 4.5-2 6-1" />
        </svg>
      );
    case "gallery":
      return (
    ...
    case "github":
      return (
        <svg {...props}>
          <path d="M9 19c-4 1-4-2-6-2.5" />
          <path d="M15 22v-3.5a3 3 0 0 0-1-2.3c3 0 6-2 6-5.5a4.3 4.3 0 0 0-1.2-3 4 4 0 0 0-.1-3s-1-.3-3.3 1.2a11 11 0 0 0-6 0C7.1 2.4 6.1 2.7 6.1 2.7a4 4 0 0 0-.1 3A4.3 4.3 0 0 0 4.8 8.7c0 3.5 3 5.5 6 5.5a3 3 0 0 0-1 2.3V22" />
        </svg>
      );
    case "external":
      return (
    ...
    case "compass":
      return (
        <svg {...props}>
          ...
          <path d="m15 9-4 1.5L9 15l4-1.5L15 9z" />
        </svg>
      );
    case "package":
      return (
...
export const NAV_ITEMS = [
  { id: "accueil", href: "/", labelKey: "accueil" },
  { id: "experiences", href: "/jobs", labelKey: "experiences" },
  { id: "formations", href: "/studies", labelKey: "formations" },
  { id: "benevolat", href: "/volunteering", labelKey: "benevolat" },
  { id: "portfolio", href: "/portfolio", labelKey: "portfolio" },
];
...
export const SECTION_COLORS = {
  ...
  competences: { soft: "var(--soleil)", deep: "var(--soleil-d)" },
};
