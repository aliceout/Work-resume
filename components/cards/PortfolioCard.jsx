  ...
  return (
    <article className="flex flex-row items-center flex-1 w-full gap-x-10">
      <div className="flex flex-col justify-between transition duration-300 shadow xl:w-10/12 xl:overflow-visible xl:flex-row rounded-xl bg-gray-50/40 dark:bg-slate-900/80">
        <div className="flex flex-col justify-between w-full px-2 pt-8 pb-4 xl:pr-0 xl:pl-10 xl:py-8 xl:basis-8/12 basis-full">
        ...
        <div className="flex mx-auto md:mb-4 xl:my-10 xl:ml-14 xl:-mr-28 drop-shadow-lg rounded-xl">
          <Image
            src={project.picture}
            width={400}
            height={300}
