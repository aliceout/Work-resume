                        ...
                        <section id="index-recent" class="column">
                            ...
                            <div class="card card-index">
                                <div class="card-content">
                                    <div class="media">
                                        ...
                                        <div class="media-left">
                                            <figure>
                                                <div class="logo"><img src="../assets/images/oclock-round.png" alt="O'Clock"></div>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="card card-index">
                                <div class="card-content">
                                    ...
                                    <div class="content">
                                        <p>Emergency responses to the health needs of populations affected by the conflict in the Central African Republic<br>
                                            <a href="experiences.php">Read more</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
