                            ...
                            <div class="card-content">
                                    ...
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                ...
                                                <h6 class="position">Logistics Officer</h6>
                                                <div class="date">2020 · 3 month </div>
                                            </div>
                                            <div class="media-left">
                                                <figure class="logo"><img src="../assets/images/mdm2.png"></figure>
                                            </div>
                                ...
                                <div class="job">
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <div class="jobTitle"><h5>HUMANITY &amp; INCLUSION</h5>
                                                    <div class="lieu">Tunis, <strong>Tunisie</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                <h6 class="position">Legal support for studies and diagnoses</h6>
                                                <div class="date">2019 · 5 months (internship)</div>
                                            </div>
                                            <div class="media-left">
                                ...
                                <div class="job">
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <div class="jobTitle"><h5>CARITAS IN MOROCCO</h5>
                                                    <div class="lieu">Rabat, <strong>Maroc</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                <h6 class="position">Program Coordination Support Officer</h6>
                                ...
                                <div class="job">
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <div class="jobTitle"><h5>MUNICIPALITY OF OLIVET</h5>
                                                    <div class="lieu">Olivet, <strong>France</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                <h6 class="position">Legal Support Officer at the Citizen Life Unit</h6>
                                                <div class="date">2015 · 2 months (internship)</div>
                                            </div>
                                            <div class="media-left">
                                ...
                                <div class="job">
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <div class="jobTitle"><h5>THE CHOCOLAT COMPANY</h5>
                                                    <div class="lieu">Toulouse, <strong>France</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                <h6 class="position">Saleswoman and preparer in chocolate factory</h6>
                                                <div class="date">2014 · 6 months</div>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                ...
                                                <h6 class="position">Assistant Manager of Transportation Services</h6>
                                        ...
                                        <div class="media">
                                            <div class="media-content">
                                                <div class="jobTitle"><h5>COOL-JET SAS</h5>
                                                    <div class="lieu">Orléans, <strong>France</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                <h6 class="position">Transportation Operations Officer</h6>
                                                <div class="date">2010-2012 · 3 years</div>
                                            </div>
                                            <div class="media-left">
                                        ...
                                        <div class="card-content">
                                            <div class="media">
                                                <div class="media-content">
                                                    <div class="jobTitle"><h5>COOL-JET SAS</h5>
                                                        <div class="lieu">Orléans, <strong>France</strong>&emsp;<i class="fa fa-map-marker-alt"></i></div></div>
                                                    <h6 class="position">Material handler</h6>
                                                    <div class="date">2009 · 3 months</div>
                                                </div>
                                                <div class="media-left">
                                                    <figure class="logo"><img src="../assets/images/cooljet.png"></figure>
                                                </div></div>
                                            <div class="content"><p>Receiving and accounting for goods, quality control and sorting of products, repackaging of goods.</p></div>
                                        </div>
                                    </div>
